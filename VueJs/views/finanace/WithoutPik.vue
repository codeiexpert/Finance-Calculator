                    ...
                    <div class="col-md-12">
                        <div class="d-flex flex-stack">
                            <div class="page-title d-flex align-items-center flex-wrap lh-1">
                                <h1 class="d-flex align-items-center text-dark fw-bolder m-0 fs-3">
                                    {{ $t('Payment and Interest')}}</h1>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control text-dark opacity-75" disabled="disabled"
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <input type="text" class="form-control text-dark opacity-75" disabled="disabled"
                                        :value="paymentData.selectedLoanLabel" />
                                </div>
                                <!--end::dropdown-->
                            </div>
                            <!--begin::datepickers-->
                            <div class="row mt-md-6 mt-4">
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="w-100">
                                        <input type="date" id="select-date"
                                            class="form-control text-dark opacity-75 form-control-solid"
                                            disabled="disabled" :value="paymentData.firstDebtRepaymentDate" />
                                    </div>
                                </div>
                                <!--end:: date-->
                                <!--begin:: date-->
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="w-100">
                                        <input type="date" id="select-date-2"
                                            class="form-control text-dark opacity-75 form-control-solid"
                                            disabled="disabled"
                                            :value="paymentData.interestPayDate != null ? paymentData.interestPayDate : ''" />
                                    </div>
                                </div>
                                <!--end:: date-->
                                <!--begin:: date-->
                                <div class="col-md-4 col-12">
                                    ...
                                    <div class="w-100">
                                        <input type="date" id="select-date-3"
                                            class="form-control text-dark opacity-75 form-control-solid"
                                            disabled="disabled"
                                            :value="paymentData.dateOfFirstInterestPayment != null ? paymentData.dateOfFirstInterestPayment : ''" />
                                    </div>
                                </div>
                                <!--end:: date-->
                            </div>
                            ...
                            <div class="accordion accordion-flush" id="accordionDuration-data">
                                <div class="accordion-item mb-2" v-for="(year, key) in years">
                                    <h2 class="accordion-header" id="flush-headingOne">
                                        <button
                                            :class="key == 0 ? 'accordion-button fw-bolder text-dark fs-6 bg-light':'accordion-button fw-bolder text-dark fs-6 bg-light collapsed'"
                                            type="button" data-bs-toggle="collapse" :data-bs-target="'#year-'+key"
                                            aria-expanded="false" aria-controls="year-collapseOne">
                                    ...
                                    <div :id="'year-'+key"
                                        :class="key == 0 ? ' accordion-collapse collapse show':'accordion-collapse collapse hide'"
                                        aria-labelledby="flush-headingOne" data-bs-parent="#accordionDuration-data">
                                        <div class="accordion-body bg-white px-0">
                                            ...
                                            <div class="table-responsive bg-white">
                                                <table class="table table-striped border m-0">
                                                    <thead>
                                                        <tr>
                                                            <th class="fw-bolder align-top">
                                                                {{ $t(table_dynamic_header) }}</th>
                                                            <th class="fw-bolder align-top">
                                                                {{ $t('Beginning Balance') }}</th>
                                                            <th class="fw-bolder align-top">{{ $t('Periodic Payment') }}
                                                                <br /><small
                                                                    class="fw-normal">({{ $t('Without Interest') }})</small>
                                                            </th>
                                                            <th class="fw-bolder align-top">{{ $t('Interest Due') }}
                                                            </th>
                                                            <th class="fw-bolder align-top">{{ $t('Total Payment') }}
                                                            </th>
                                                            <th class="fw-bolder align-top">{{ $t('Ending Balance') }}
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
    ...
    export default {
            ...
            if (this.$route.params.id) {
                ...
                Debt.getDebtFinanceData(this.$route.params.id).then(res => {
                    ...
                    if (payment_data != null) {
                        ...
                        this.paymentData.dateOfFirstInterestPayment = finance_data
                        ...
                        if (payment_data.specialPayment.length > 0 && payment_data.specialPayment[0].payment !=
                            null && payment_data.specialPayment[0].date != null) {
        ...
        methods: {
            async showTableData(freq, payment_data) {
                ...
                const months_arr = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sept', 'Oct', 'Nov',
                    'Dec'
                ]
                var years_arr = []
                ...
                if (loan_type == 'amortizing-loan') {
                    ...
                    if (freq == 'monthly') {
                        ...
                        var total_payment_calc_1 = parseFloat(parseFloat(global_simple_interest_rate_per_month) *
                            parseFloat(main_principal_ammount))
                        var total_payment_calc_2 = parseFloat(1 - Math.pow((1 + parseFloat(
                            global_simple_interest_rate_per_month)), parseInt('-' +
                            total_number_of_months)))
                        var total_payable_ammount = parseFloat(parseFloat(total_payment_calc_1) / parseFloat(
                            total_payment_calc_2))
                        ...
                        total_year_months_arr.forEach(function (ele) {
                            ...
                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                global_simple_interest_rate_per_month))

                            var data_for_year = self.$t('Year')+' '+ ele.year
                            var final_selected_month = months_arr[ele.month - 1]

                            var final_interest_per_data = parseFloat(interest_per_data).toLocaleString(
                                'de-DE', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                })

                            var final_total_payable_ammount = parseFloat(total_payable_ammount)
                                .toLocaleString('de-DE', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                })

                            var periodic_payment = parseFloat(total_payable_ammount) - parseFloat(
                                interest_per_data)
                            var main_ele = ele

                            var final_periodic_ammount = parseFloat(periodic_payment).toLocaleString(
                                'de-DE', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                })
                            ...
                            if (special_payments != '' || special_payments.length > 0) {
                                ...
                                special_payments.forEach(function (ele) {
                                    ...
                                    if (special_payment_month == main_ele.month &&
                                        special_payment_year == main_ele.year) {
                                        self.years_data.push({
                                            special_payment: true,
                                            for: data_for_year,
                                            selected_month: months_arr[
                                                special_payment_month - 1],
                                            main_ammount: parseFloat(principal_ammount)
                                                .toLocaleString('de-DE', {
                                                    minimumFractionDigits: 2,
                                                    maximumFractionDigits: 2
                                                }),
                                            periodic_payment: ele.payment.toLocaleString(
                                                'de-DE', {
                                                    minimumFractionDigits: 2,
                                                    maximumFractionDigits: 2
                                                }) + ' (Special Payment)',
                                            ...
                                            ending_balance: parseFloat(principal_ammount -
                                                ele.payment).toLocaleString('de-DE', {
                                                minimumFractionDigits: 2,
                                                maximumFractionDigits: 2
                                            }),
                            ...
                            var previous_principal_ammount = parseFloat(principal_ammount).toLocaleString(
                                'de-DE', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                })

                            principal_ammount = parseFloat(parseFloat(principal_ammount) - parseFloat(
                                periodic_payment))
                            // if(parseFloat(principal_ammount) <= 0  && special_payments == '' ){
                            //     principal_ammount = parseFloat(0)
                            // }

                            var final_ending_balance = parseFloat(principal_ammount).toLocaleString(
                            'de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                        ...
                        if (parseInt(month) > 0 && parseInt(month) <= 3) {
                            ...
                            if (parseInt(month) == 6) {
                                ...
                                var total_number_of_quater_for_calc = parseFloat((parseInt(year) * 4) + 1 + '.' + (
                                    month - 3))
                            }
                            ...
                            if (parseInt(month) == 9) {
                                ...
                                var total_number_of_quater_for_calc = parseFloat((parseInt(year) * 4) + 2 + '.' + (
                                    month - 6))
                            }
                            ...
                            if (parseInt(month) == 9) {
                                ...
                                var total_number_of_quater_for_calc = parseFloat((parseInt(year) * 4) + 3 + '.' + (
                                    month - 9))
                            }
                        } else {
                        ...
                        for (var i = 0; i < total_number_of_quarters; i++) {
                            ...
                            var selected_month = months_arr[select_date_key_1.getMonth()] + ' ' + select_date_key_1
                                .getFullYear() + ' - ' + months_arr[select_date_key_2.getMonth()] + ' ' +
                                select_date_key_2.getFullYear()
                            ...
                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                amortizing_interest_rate_per_quarter))

                            var total_payment_calc_1 = parseFloat(parseFloat(amortizing_interest_rate_per_quarter) *
                                parseFloat(main_principal_ammount))
                            var total_payment_calc_2 = parseFloat(1 - Math.pow((1 + parseFloat(
                                amortizing_interest_rate_per_quarter)), parseFloat('-' +
                                total_number_of_quater_for_calc)))
                            var total_payable_ammount = parseFloat(parseFloat(total_payment_calc_1) / parseFloat(
                                total_payment_calc_2))
                            ...
                            var final_periodic_ammount = parseFloat(periodic_payment).toLocaleString('de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                            var self = this
                            ...
                            if (special_payments != '' || special_payments.length > 0) {
                                ...
                                special_payments.forEach(function (ele) {
                                    ...
                                    if (special_payment_month >= select_date_key_1.getMonth() &&
                                        special_payment_month <= select_date_key_2.getMonth() &&
                                        special_payment_year == data_for_year) {
                                        ...
                                        self.years_data.push({
                                            ...
                                            periodic_payment: ele.payment.toLocaleString('de-DE', {
                                                minimumFractionDigits: 2,
                                                maximumFractionDigits: 2
                                            }) + ' (Special Payment)',
                                            interest_per_data: '-',
                                            total_payable_ammount: '-',
                                            ending_balance: parseFloat(principal_ammount - ele
                            ...
                            var previous_principal_ammount = parseFloat(principal_ammount).toLocaleString('de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                            ...
                            var final_total_payable_ammount = parseFloat(total_payable_ammount).toLocaleString(
                                'de-DE', {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2
                                })

                            var final_interest_per_data = parseFloat(interest_per_data).toLocaleString('de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                            ...
                            var final_ending_balance = parseFloat(principal_ammount).toLocaleString('de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                        ...
                        if (parseInt(month) > 6) {
                            ...
                            if (parseInt(month) < 12) {
                                var total_number_of_half_years_for_calc = parseFloat((parseInt(year) * 2) + 1 +
                                    '.' + (month - 6))
                            }
                            ...
                            if (parseInt(month) == 6) {
                                ...
                                var total_number_of_half_years_for_calc = parseFloat((parseInt(year) * 2) + '.' +
                                    month)
                            }
                        ...
                        for (var i = 0; i < total_number_of_half_years; i++) {
                            ...
                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                amortizing_interest_rate_per_half_year))

                            var total_payment_calc_1 = parseFloat(parseFloat(
                                amortizing_interest_rate_per_half_year) * parseFloat(main_principal_ammount))
                            var total_payment_calc_2 = parseFloat(1 - Math.pow((1 + parseFloat(
                                amortizing_interest_rate_per_half_year)), parseFloat('-' +
                                total_number_of_half_years_for_calc)))
                            var total_payable_ammount = parseFloat(parseFloat(total_payment_calc_1) / parseFloat(
                                total_payment_calc_2))
                        ...
                        for (var i = 0; i < total_number_of_years; i++) {
                            ...
                            var final_selected_year = months_arr[select_date_key_1.getMonth()] + ' ' +
                                select_date_key_1.getFullYear() + ' - ' + months_arr[select_date_key_2.getMonth()] +
                                ' ' + select_date_key_2.getFullYear()

                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                amortizing_interest_rate_per_year))
                            ...
                            var total_payment_calc_1 = parseFloat(parseFloat(amortizing_interest_rate_per_year) *
                                parseFloat(main_principal_ammount))
                            var total_payment_calc_2 = parseFloat(1 - Math.pow((1 + parseFloat(
                                amortizing_interest_rate_per_year)), parseFloat('-' +
                                total_number_of_years_for_calc)))
                            var total_payable_ammount = parseFloat(parseFloat(total_payment_calc_1) / parseFloat(
                                total_payment_calc_2))
                    ...
                    if (freq == 'monthly') {
                        ...
                        total_year_months_arr.forEach(function (ele) {
                            ...
                            var periodic_payment = parseFloat(parseFloat(total_payable_ammount) -
                                parseFloat(interest_per_data))
                            ...
                            var final_periodic_payment = periodic_payment.toLocaleString('de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                            var final_interest_per_data = interest_per_data.toLocaleString('de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                            var final_total_payable_ammount = total_payable_ammount.toLocaleString(
                            'de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                            var final_ending_balance = ending_balance.toLocaleString('de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                        ...
                        for (var i = 0; i < total_number_quarter_for_periodic_val; i++) {
                            ...
                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                annuity_interest_rate_per_quarter))
                            var total_payment_calc_1 = parseFloat(parseFloat(annuity_interest_rate_per_quarter) *
                                parseFloat(main_principal_ammount))
                            var total_payment_calc_2 = parseFloat(1 - Math.pow((1 + parseFloat(
                                annuity_interest_rate_per_quarter)), parseFloat('-' +
                                total_number_of_quater_for_calc)))
                            var total_payable_ammount = parseFloat(parseFloat(total_payment_calc_1) / parseFloat(
                                total_payment_calc_2))
                            ...
                            var periodic_payment = parseFloat(parseFloat(total_payable_ammount) - parseFloat(
                                interest_per_data))
                            ...
                            var final_total_payable_ammount = total_payable_ammount.toLocaleString('de-DE', {
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                            })
                            var final_ending_balance = ending_balance.toLocaleString('de-DE', {
                        ...
                        if (parseInt(month) > 6) {
                            ...
                            if (parseInt(month) < 12) {
                                var total_number_of_half_yearly_for_calc = parseFloat((parseInt(year) * 2) + 1 +
                                    '.' + (month - 6))
                            }
                            ...
                            if (parseInt(month) == 6) {
                                ...
                                var total_number_of_half_yearly_for_calc = parseFloat((parseInt(year) * 2) + '.' +
                                    month)
                            }
                        ...
                        for (var i = 0; i < total_number_year_for_periodic_val; i++) {
                            ...
                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                annuity_interest_rate_per_half_yearly))

                            var total_payment_calc_1 = parseFloat(parseFloat(
                                annuity_interest_rate_per_half_yearly) * parseFloat(main_principal_ammount))
                            var total_payment_calc_2 = parseFloat(1 - Math.pow((1 + parseFloat(
                                annuity_interest_rate_per_half_yearly)), parseFloat('-' +
                                total_number_of_half_yearly_for_calc)))
                            var total_payable_ammount = parseFloat(parseFloat(total_payment_calc_1) / parseFloat(
                                total_payment_calc_2))
                        ...
                        for (var i = 0; i < total_number_of_years; i++) {
                            ...
                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                annuity_interest_rate_per_year))

                            var total_payment_calc_1 = parseFloat(parseFloat(annuity_interest_rate_per_year) *
                                parseFloat(main_principal_ammount))
                            var total_payment_calc_2 = parseFloat(1 - Math.pow((1 + parseFloat(
                                annuity_interest_rate_per_year)), parseFloat('-' +
                                total_number_of_years_for_calc)))
                            var total_payable_ammount = parseFloat(parseFloat(total_payment_calc_1) / parseFloat(
                                total_payment_calc_2))
                    ...
                    var calc_bullet_loan_total_payment = function (interest, num_of_payments, pv, fv = 0.00, Type =
                        0) {
                        var xp = Math.pow((1 + interest), num_of_payments)
                        var calc_fst = (parseFloat(pv) * parseFloat(interest) * parseFloat(xp) / (parseFloat(
                                xp) - 1) - parseFloat(interest) / parseFloat(parseFloat(xp) - 1) *
                            parseFloat(fv))
                    ...
                    if (freq == 'monthly') {
                        ...
                        var total_payable_ammount = calc_bullet_loan_total_payment(
                            global_simple_interest_rate_per_month, total_number_of_months,
                            main_principal_ammount, bullet_payment_data)
                        ...
                        for (var i = 0; i < total_number_of_quarters; i++) {
                            ...
                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                bullet_interest_rate_per_quarter))

                            if (repay_date.getFullYear() == last_date.getFullYear() && month > 0 && month <= 3 &&
                                repay_date.getMonth() >= 0 && repay_date.getMonth() < 3) {
                                bullet_interest_rate_per_quarter = global_simple_interest_rate_per_month * last_date
                                    .getMonth()
                            } else if (repay_date.getFullYear() == last_date.getFullYear() && month > 3 && month <=
                                6 && repay_date.getMonth() >= 3 && repay_date.getMonth() < 6) {
                                bullet_interest_rate_per_quarter = global_simple_interest_rate_per_month * (
                                    last_date.getMonth() - 3)
                            } else if (repay_date.getFullYear() == last_date.getFullYear() && month > 6 && month <=
                                9 && repay_date.getMonth() >= 6 && repay_date.getMonth() < 9) {
                                bullet_interest_rate_per_quarter = global_simple_interest_rate_per_month * (
                                    last_date.getMonth() - 6)
                            } else if (repay_date.getFullYear() == last_date.getFullYear() && month > 9 && month <=
                                12 && repay_date.getMonth() >= 9) {
                                bullet_interest_rate_per_quarter = global_simple_interest_rate_per_month * (
                            ...
                            var total_payable_ammount = calc_bullet_loan_total_payment(
                                bullet_interest_rate_per_quarter, total_number_of_quarters,
                                main_principal_ammount, bullet_payment_data)
                        ...
                        for (var i = 0; i < total_number_year_for_periodic_val; i++) {
                            ...
                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                bullet_interest_rate_per_half_year))

                            if (repay_date.getFullYear() == last_date.getFullYear() && month > 0 && month <= 6 &&
                                repay_date.getMonth() >= 0 && repay_date.getMonth() < 6) {
                                bullet_interest_rate_per_half_year = global_simple_interest_rate_per_month * month
                            } else if (repay_date.getFullYear() == last_date.getFullYear() && month > 6 &&
                                repay_date.getMonth() >= 6) {
                                bullet_interest_rate_per_half_year = global_simple_interest_rate_per_month * (
                                    month - 6)
                            }
                            var data_for_year = repay_date.getFullYear()
                            var final_selected_month = selected_month
                            ...
                            var total_payable_ammount = calc_bullet_loan_total_payment(
                                bullet_interest_rate_per_half_year, total_number_year_for_periodic_val,
                                main_principal_ammount, bullet_payment_data)
                        ...
                        for (var i = 0; i < total_number_of_years; i++) {
                            ...
                            interest_per_data = parseFloat(parseFloat(principal_ammount) * parseFloat(
                                bullet_interest_rate_per_year))

                            if (repay_year.getFullYear() == last_date.getFullYear() && month > 0 && repay_year
                                .getMonth() >= 0) {
                                bullet_interest_rate_per_year = global_simple_interest_rate_per_month * month
                            }
                            var total_payable_ammount = calc_bullet_loan_total_payment(
                                bullet_interest_rate_per_year, total_number_of_years, main_principal_ammount,
                                bullet_payment_data)
